...
<script language="javascript">
	...
	function postInvoke( resultMsg, invokeId )
	{
		switch( invokeId )
		{
			case 'success':
				alert('성공적으로 등록되었습니다.');
				location.href="/A_online.do?method=view&did=${param.parentId}";
			break;
...
<div id="board_form" style="width:700">
		...
		<div class="board_write">
				<table cellspacing="1" cellpadding="0" width="100%">
					...
					<tr>
						<th>제목</th>
						<td><input name="title" type="text"  class="box1" style="width:98%"  value=""></td>
					</tr>
					<tr>
						<th>접수기간</th>
						<td align="left">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="300" class="reg_text"><input name="receiptSdate" type="text" class="bbs_texts" id="receiptSdate" style="background-color:#ffffff; border:#BCBCBC solid 1px;width:100;" size="20" maxlength="10"  readonly>
										<img src="/cms/img/btn/btn_date.gif" align="absmiddle" style="cursor:hand" onClick="return showCalendar('receiptSdate', 'y-mm-dd');">&nbsp; ~
										<input name="receiptEdate" type="text" class="bbs_text" id="receiptEdate" style="background-color:#ffffff; border:#BCBCBC solid 1px;width:100;" size="20"  maxlength="10" readonly>
					...
					<tr>
						...
						<td align="left">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="300" class="reg_text"><input name="lecSdate" type="text" class="bbs_texts" id="lecSdate" style="background-color:#ffffff; border:#BCBCBC solid 1px;width:100;" size="20" maxlength="10"  readonly>
										<img src="/cms/img/btn/btn_date.gif" align="absmiddle" style="cursor:hand" onClick="return showCalendar('lecSdate', 'y-mm-dd');">&nbsp; ~
										<input name="lecEdate" type="text" class="bbs_text" id="lecEdate" style="background-color:#ffffff; border:#BCBCBC solid 1px;width:100;" value="" size="20"  maxlength="10" readonly>
		...
		`<div class="board_write">
				<table id="managerTbl" cellspacing="1" cellpadding="0" width="100%">
					...
					<tr>
						<td><input name="managerFieldName" type="text"  class="box1" style="width:98%"  value=""></td>
						<td><input name="managerFieldValue" type="text"  class="box1" style="width:98%"  value=""></td>
					</tr>
				</table>       
			...
			<div class="board_btn">
				...
				<!--a href="javascript:list(document.form);" --><a href="/A_online.do?method=view&did=${param.parentId}"><img src="/skin/images/btn_cancel.gif" alt="취소 버튼"></a>
			</div><br/>
