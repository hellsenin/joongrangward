...
<script type="text/javascript">
	...
	function insert()
	{
		...
		if(checkForm(object))
		{
			object.action = "/A_online.do?method=saveAcceptData";
			object.submit();
		}
	}
	</script>
...
<div id="board_form" style="width:700">
		...
		<div class="board_write">
          	...
          	<c:forEach var="x" begin="0" end="${zvl.size-1}">
					<tr>
						...
						<td>
							...
							<c:if test="${zvl.FIELD_TYPE[x] == 'date'}">
							<input type="text" id="fieldValue" name="fieldValue" fieldType="date"  class="box1" style="width:100%" />
							</c:if>
						</td>
					</tr>
				</c:forEach>
			...
			<c:if test="${not empty zvl.CONTENT_NM[0]}">
					...
					<tr>
						<td colspan="2">
								<textarea id="contents" name="contents"  style="width:100%; height:400px;"></textarea>
						</td>
					</tr>	
			</c:if>
					<!-- 글내용 끝 -->
