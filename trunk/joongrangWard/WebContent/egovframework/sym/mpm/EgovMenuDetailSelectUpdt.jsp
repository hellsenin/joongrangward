...
function updateMenuManage(form) {
	if(confirm("<spring:message code="common.save.msg" />")){
		if(!validateMenuManageVO(form)){ 			
            ...
            form.action="/sym/mpm/EgovMenuDetailSelectUpdt.do";
			form.submit();
		}
	}
}
...
function deleteMenuManage(form) {
	if(confirm("<spring:message code="common.delete.msg" />")){
        form.action="/sym/mpm/EgovMenuManageDelete.do";
		form.submit();
	}
}
/* ********************************************************
...
<body> 
<form:form commandName="menuManageVO" name="frm" >
<DIV id="main" style="display:"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;메뉴상세조회및 수정</td>
 </tr>
</table>
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr> 
    <th width="15%" height="23" class="required_text" nowrap >메뉴No<img src="${ImgUrl}icon/required.gif" width="15" height="15"></th>
    <td width="35%" nowrap>
  ...
  <tr> 
    ...
    <td width="35%" nowrap>&nbsp;
      <form:input path="menuNm" size="30" cssClass="txaIpt" maxlength="30" />
  ...
  <tr> 
    ...
    <td width="35%" nowrap>&nbsp;
      <form:input path="siteId" size="30" cssClass="txaIpt" maxlength="30" />
  ...
  <tr> 
    <td height="10">
		...
		<tr> 
		  ...
		  <td width="10">&nbsp;</td>
		  <td height="10"><img src="${ImgUrl}button/bu2_left.gif" width="8" height="20"></td>
		  <td background="${ImgUrl}button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:updateMenuManage(document.forms[0])">수정</a></td>
		  <td><img src="${ImgUrl}button/bu2_right.gif" width="8" height="20"></td>      
		  <td width="10">&nbsp;</td>
		  <td height="10"><img src="${ImgUrl}button/bu2_left.gif" width="8" height="20"></td>
		  <td background="${ImgUrl}button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:deleteMenuManage(document.forms[0])">삭제</a></td>
		  <td><img src="${ImgUrl}button/bu2_right.gif" width="8" height="20"></td>  
		</tr>
		</table>
    </td>
