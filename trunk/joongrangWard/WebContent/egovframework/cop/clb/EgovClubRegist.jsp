...
<div id="border" style="width:730px">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr> 
	    <th width="20%" height="23" class="required_text" nowrap >소속 커뮤니티 정보
	    ...
	    <td width="30%" nowrap colspan="3">
	     	...
	     	<input type="text" name="cmmntyNm" value="" size="20" readOnly />
	     &nbsp;<a href="javascript:fn_egov_inqire_cmmnty()" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	  ...
	  <tr> 
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="javascript:fn_egov_inqire_cmmntyUser()" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	     			width="15" height="15" align="absmiddle" alt="search"></a>
