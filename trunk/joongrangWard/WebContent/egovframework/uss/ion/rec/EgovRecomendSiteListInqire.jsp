 ...
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_inquire_recomendsitelistdetail(recomendSiteId) {		

  document.RecomendSiteListForm.recomendSiteId.value = recomendSiteId;	
  document.RecomendSiteListForm.action = "<c:url value='/uss/ion/rec/RecomendSiteDetailInqire.do'/>";
  document.RecomendSiteListForm.submit();	
...
<form name="RecomendSiteListForm" action="" method="post">
<input name="recomendSiteId" type="hidden" value="">

<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <img src="/images/egovframework/uss/ion/rec/icon/tit_icon.gif" width="16" height="16" hspace="3" align="left">&nbsp;추천사이트목록 조회</td>
  <th>
  </th>
  <td width="10%">
   ...
   <table border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td background="/images/egovframework/uss/ion/rec/button/bu2_bg.gif" class="text_left" nowrap>
      		<a href="javascript:fn_egov_search_recomendsiteinfo();">조회</a> 
      </td>
      ...
      <td background="/images/egovframework/uss/ion/rec/button/bu2_bg.gif" class="text_left" nowrap>
      		<a href="javascript:fn_egov_regist_recomendsiteinfo();">등록</a> 
      </td>
...
<tr>      
    ...
    <th class="title" width="20%" nowrap>추천사이트명</th>        
    <th class="title" width="30%" nowrap>추천사이트URL</th>           
    <th class="title" width="10%" nowrap>승인여부</th>        
...
<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
  <tr style="cursor:hand;" onClick="fn_egov_inquire_recomendsitelistdetail('<c:out value="${resultInfo.recomendSiteId}"/>')">
		<td class="lt_text3"><c:out value="${(searchVO.pageIndex-1) * searchVO.pageSize + status.count}"/></td>	        
		<td class="lt_text3"><c:out value="${resultInfo.recomendSiteNm}"/></td>		
