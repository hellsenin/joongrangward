...
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="CnsltManageForm"  method="post" onsubmit="fn_egov_confirm_qnapassword();">
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="/images/egovframework/uss/olp/cns/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;작성 비밀번호 확인</td>
 </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >작성글 비밀번호
    	<img src="/images/egovframework/uss/olp/cns/icon/required.gif" width="15" height="15"></th>
    <td width="80%" nowrap>
