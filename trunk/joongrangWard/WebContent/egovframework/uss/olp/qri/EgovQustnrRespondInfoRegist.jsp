...
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		varFrom.action =  "/uss/olp/qri/EgovQustnrRespondInfoRegist.do";
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;설문조사 등록</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr> 
	...
	<img src="${ImgUrl}img/search2.gif" align="absmiddle" style="border:0px" alt="설문관리정보" title="설문관리정보">
	</a>
  ...
  <tr> 
	...
	<img src="${ImgUrl}img/search2.gif" align="absmiddle" style="border:0px" alt="설문문항정보" title="설문문항정보">
	</a>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
    	<div name="divQestnTyCode" id="divQestnTyCode"></div>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
		<input name="qustnrIemCn" id="qustnrIemCn" type="text" size="73" value="" maxlength="4000" style="width:300px;">
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
      <textarea name="respondAnswerCn" class="textarea"  cols="75" rows="4"  style="width:100%;" value=""></textarea>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
      <textarea name="etcAnswerCn" class="textarea"  cols="75" rows="4"  style="width:100%;" value=""></textarea>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
		<input name="respondNm" type="text" size="50" value="" maxlength="50" style="width:120px;">
