...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;설문문항 통계</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >설문항목 결과<img src="${ImgUrl}icon/required.gif" width="15" height="15"></th>
    <td width="80%" nowrap>
    <br>
    ...
    <c:forEach items="${statisticsList}" var="statisticsList" varStatus="status">
	    ...
	    <td>
	    <img src="/images/egovframework/uss/olp/qqm/chart/chart${status.count}.JPG" width="${statisticsList.qustnrPercent}px" height="8"> ${statisticsList.qustnrPercent}%
	    </td>
	    </tr>
    </c:forEach>
    </table>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >응답자답변내용 결과<img src="${ImgUrl}icon/required.gif" width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >기타답변내용 결과<img src="${ImgUrl}icon/required.gif" width="15" height="15"></th>
    <td width="80%" nowrap>
    <table border="0" cellpadding="0" cellspacing="0">
    <c:forEach items="${statisticsList2}" var="statisticsList2" varStatus="status">
