  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  <td align="left" valign="top">
        ...
        <tr>
          <td>
          <img src="/images/egovframework/cmm/uat/uia/01_t01.gif" width="131" height="13"><br>
        ...
        <tr>
          <td>
            <table cellpadding="0" cellspacing="0" border="0" width="572">
              <tr>
                <td>
            <img src="/images/egovframework/cmm/uat/uia/01_t02.gif" width="97" height="13"><br>
        ...
        <tr>
          <td>
          <img src="/images/egovframework/cmm/uat/uia/01_t03.gif" width="72" height="13"><br>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    <td width="15" align="left"><img src="/images/egovframework/cmm/uat/uia/icon01.gif" width="9" height="13" /></td>
        ...
        <tr>
          <td>
            <table width="572" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="/images/egovframework/cmm/uat/uia/01_t04.gif" width="111" height="13"><br>
