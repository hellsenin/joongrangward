...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="/images/egovframework/cmm/sym/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;공통코드 목록</td>
  <th>
  </th>
  <td width="10%">
...
<tr>  
	...
	<th class="title" width="30%" nowrap>분류명</th>
	<th class="title" width="15%" nowrap>코드ID</th>
	<th class="title" width="30%" nowrap>코드ID명</th>
	<th class="title" width="15%" nowrap>사용여부</th>
</tr>
</thead>    
<tbody>
