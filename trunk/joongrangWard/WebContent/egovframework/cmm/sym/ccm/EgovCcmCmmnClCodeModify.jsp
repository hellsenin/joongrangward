...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="/images/egovframework/uss/olp/mgt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;공통분류코드 수정</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >분류코드<img src="/images/egovframework/uss/olp/mgt/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap colspan="3">
     	${cmmnClCode.clCode}
    </td>
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >분류코드명<img src="/images/egovframework/uss/olp/mgt/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
...
<tr> 
  ...
  <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="JavaScript:fn_egov_modify_CmmnClCode(document.cmmnClCode);">저장</a></td>
