...
<form name="normalWeekCalendar" action ="<c:url value='/sym/cal/EgovNormalWeekCalendar.do'/>" method="post">
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	  <tr>
	    <td width="200" class="title_left"><img src="/images/egovframework/cmm/sym/cal/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;일반달력 주간</td>
	  	<td>
