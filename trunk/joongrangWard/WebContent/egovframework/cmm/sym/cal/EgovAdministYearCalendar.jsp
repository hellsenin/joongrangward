...
<form name="administYearCalendar" action ="<c:url value='/sym/cal/EgovAdministYearCalendar.do'/>" method="post">
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	  <tr>
	    <td width="400" class="title_left"><img src="/images/egovframework/cmm/sym/cal/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;행정달력 연간</td>
	  	<td>
