...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/egovframework/cmm/sym/zip/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;우편번호 상세조회</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >우편번호<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>
    <td><c:out value='${fn:substring(result.zip, 0,3)}'/>-<c:out value='${fn:substring(result.zip, 3,6)}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >시도명<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td>${result.ctprvnNm}</td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >시군구명<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td>${result.signguNm}</td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >읍면동명<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td>${result.emdNm}</td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >리건물명<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td>${result.liBuldNm}</td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >번지동호<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" alt="필수"  width="15" height="15"></th>          
...
<tr> 
  ...
  <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_modify_Zip();">수정</a></td>
  ...
  <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_delete_Zip();">삭제</a></td>  
