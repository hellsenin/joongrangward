...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="/images/egovframework/cmm/sym/zip/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;우편번호 목록</td>
  <th>
  </th>
  <td width="10%">
  ...
  <th width="10%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_search_Zip();">조회</a></td>
      ...
      <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_regist_Zip();">등록</a></td>
      <td><img src="/images/egovframework/cmm/sym/ccm/btn/bu2_right.gif" alt="등록" width="8" height="20"></td>
      <td width="10"></td>

      <td><img src="/images/egovframework/cmm/sym/ccm/btn/bu2_left.gif" alt="엑셀등록" width="8" height="20"></td>
      <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_regist_ExcelZip();">엑셀등록</a></td>
      <td><img src="/images/egovframework/cmm/sym/ccm/btn/bu2_right.gif" alt="엑셀등록" width="8" height="20"></td>
    </tr>
   </table>
  </th>  
 </tr>
