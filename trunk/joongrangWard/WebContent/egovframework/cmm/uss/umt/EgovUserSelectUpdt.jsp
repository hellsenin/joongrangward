...
<body>
        <!-- content start -->
        <form:form commandName="userManageVO" action="/uss/umt/user/EgovUserSelectUpdt.do" name="userManageVO" method="post" >
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;업무사용자 상세조회(수정)</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr>
                ...
                <td width="80%" nowrap>
                    <form:input path="emplyrNm" cssClass="txaIpt" size="20"  maxlength="60" />
            ...
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                집전화번호<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr> 
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center" >
		            <tr> 
		                ...
		                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" width="8" height="20"></td>
		                <td background="/images/egovframework/cmm/uss/umt/button/bu2_bg.gif" class="text_left" nowrap>
		                <a href="javascript:fnDeleteUser('<c:out value='${userManageVO.userTy}'/>:<c:out value='${userManageVO.uniqId}'/>');"><spring:message code="button.delete" /></a></td>
		                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" width="8" height="20"></td>
		                <td>&nbsp;</td>
		                <!-- 목록 -->
		                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" width="8" height="20"></td>
