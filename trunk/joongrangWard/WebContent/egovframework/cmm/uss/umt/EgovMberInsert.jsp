...
<body>
        <!-- content start -->
        <form:form commandName="mberManageVO" action="/uss/umt/mber/EgovMberInsert.do" name="mberManageVO"  method="post" >
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;일반회원 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr> 
                ...
                <td width="80%" nowrap><input name="mberNm" type="text" size="20" value=""  maxlength="60" ></td>
            </tr>
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
