...
<table class="table-line">
    ...
    public String getExistDirectory(String targetDirPath)<br>
        타겟경로<input type="text" name="targetDirPath1" >
        </td>
    </tr> 
    <tr>
        <td>
    ...
    public ArrayList getExistDirectory(String baseDirPath, String targetDirPath, int dirCnt)<br>
        기본경로<input type="text" name="baseDirPath2" >예) c:/data/home, /data/home<br>
        타겟경로<input type="text" name="targetDirPath2" >예) conf<br>
        찾을갯수<input type="text" name="dirCnt2" >예) 1, 100
        </td>
    </tr>
    <tr>
        <td>
    ...
    public String getExistDirectory(String targetDirPath, String fromDate, String toDate)<br>
        타겟경로<input type="text" name="targetDirPath3" >예) c:/data/home, /data/home<br>
        조건-시작일자<input type="text" name="fromDate3" >예) 20090101<br>
        조건-종료일자<input type="text" name="toDate3" >예) 20090131
        </td>
    </tr>
    <tr>
        <td>
    ...
    public String getExistDirectory(String targetDirPath, String ownerName)<br>
        타겟경로<input type="text" name="targetDirPath4" >예) c:/data/home, /data/home<br>
        생성자<input type="text" name="ownerName4" >예) user01
        </td>
    </tr>
    <tr>
...
<table class="table-line">
    ...
    <tr>
        ...
        하위디렉토리에 타겟경로의 디렉토리가 존재하면 경로출력, 존재하지 않으면 블랭크<br>
    public ArrayList getExistDirectory(String baseDirPath, String targetDirPath, int dirCnt)<br>
        기본경로<input type="text" name="baseDirPath2"   value=<%= baseDirPath2 %>>예) c:/data/home, /data/home<br>
        타겟경로<input type="text" name="targetDirPath2" value=<%= targetDirPath2 %>>예) conf<br>
        찾을갯수<input type="text" name="dirCnt2" value=<%=dirCnt2 %>><br>
    ...
    public String getExistDirectory(String targetDirPath, String fromDate, String toDate)<br>
        타겟경로<input type="text" name="targetDirPath3" value=<%= targetDirPath3 %>>예) c:/data/home, /data/home<br>
        조건-시작일자<input type="text" name="fromDate3"  value=<%= fromDate3 %>>예) 20090101<br>
        조건-종료일자<input type="text" name="toDate3"    value=<%= toDate3 %>>예) 20090131<br>
        결과:<%=result3 %>
        </td>
    </tr>
    <tr>
        ...
        대상디렉토리의 생성자가 일치하면 경로 출력, 일치하지 않으면 블랭크<br>
    public String getExistDirectory(String targetDirPath, String ownerName)<br>
        타겟경로<input type="text" name="targetDirPath4" value=<%= targetDirPath4 %>>예)c:/data/home, /data/home<br>
        생성자<input type="text" name="ownerName4" value=<%= ownerName4 %>>예) user01<br>
        결과:<%=result4 %>
        </td>
    </tr>
    <tr>
