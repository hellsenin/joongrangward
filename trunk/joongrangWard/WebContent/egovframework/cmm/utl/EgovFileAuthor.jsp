...
<table width="430" border="0" cellpadding="0" cellspacing="1" class="table-register">
    <tr>
      <th width="150" height="23" class="required_text" nowrap>파일(디렉토리) 읽기권한</th>
      <td width="280" height="23" class="title_left" nowrap><input type = "button" method="post"  value="실행!" onclick="readForm.submit()"></td>
    </tr>
    <tr>
      <th width="150" height="23" class="title_left" nowrap>파일명</td>
      <td width="280" height="23" class="title_left" nowrap><input type = "text" name="filepath" value="" size="40"></td>
    </tr>
</table>
</form>
<!-- 파일읽기 화면 끝 -->
...
<table width="430" border="0" cellpadding="0" cellspacing="1" class="table-register">
    <tr>
      <th width="150" height="23" class="required_text" nowrap>파일(디렉토리) 쓰기기권한</th>
      <td width="280" height="23" class="title_left" nowrap><input type = "button" method="post"  value="실행!" onclick="writeForm.submit()"></td>
    </tr>
    <tr>
      <th width="150" height="23" class="title_left" nowrap>파일명</td>
      <td width="280" height="23" class="title_left" nowrap><input type = "text" name="filepath" value="" size="40"></td>
