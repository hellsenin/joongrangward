...
%>
<!-- PDF 파일변환 화면  시작-->
<!-- form name="convertPDFForm" action ="/EgovPageLink.action  sym/mpm/testpdf.do" method="post" enctype="multipart/form-data" -->
<form name="convertPDFForm" action ="/EgovPageLink.action" method="post" enctype="multipart/form-data">
