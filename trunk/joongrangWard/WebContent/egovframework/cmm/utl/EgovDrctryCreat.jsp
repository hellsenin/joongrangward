...
<table class="table-line">
    ...
    <tr>
        ...
        생성경로<input type="text" name="dirCreationPath" >예) c:/data/home/dir1, /data/home/dir1<br>
        </td>
    </tr>
    <tr>
        <td>
        ...
        생성경로<input type="text" name="fileCreationPath" >예) c:/data/home/file1.txt, /data/home/file1.txt<br>
        </td>
    </tr>
    <tr>
...
<table class="table-line">
    ...
    <tr>
        ...
        생성할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 생성<br>
        기존에 디렉토리가 존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        생성경로<input type="text" name="dirCreationPath" value="<%=dirCreationPath %>">예) c:/data/home/dir1, /data/home/dir1<br>
        결과 : <%=result1 %>
        </td>
    </tr>
    <tr>
        ...
        생성할 파일의 절대경로를 입력하면 해당되는 파일를 생성<br>
        기존에 파일이 존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        생성경로<input type="text" name="fileCreationPath" value="<%=fileCreationPath %>">예) c:/data/home/file1.txt, /data/home/file1.txt<br>
        결과 : <%=result2 %>
        </td>
    </tr>
    <tr>
