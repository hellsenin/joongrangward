...
<table border="1">
	<tr><td>            기능설명:</td><td>입력일자가  유효한 일자인지 확인하는 기능<br></td></tr>
 	<tr><td>      일자(yyyyMMdd):</td><td><input type = "text" name="sDate"  size=8><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready1()"></td></tr>
</table>
</form>
<!--  준비화면 끝 -->
<%
...
<table border="1">
	<tr><td>            기능설명:</td><td>입력시간이  유효한지 시간인지 확인하는 기능<br></td></tr>
 	<tr><td>          시간(HHmm):</td><td><input type = "text" name="sTime"  size=4><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready2()"></td></tr>
</table>
</form>
<!--  준비화면 끝 -->
<%
...
<table border="1">
	<tr><td>            기능설명:</td><td>입력일자의 요일이 입력요일과  동일한지 확인하는 기능<br></td></tr>
 	<tr><td>      일자(yyyyMMdd):</td><td><input type = "text" name="sDate"  size=8></td></tr>
 	<tr><td>요일(1~7 ; 1:일요일):</td><td><select name="sWeek"><option value=1>일요일</option><option value=2>월요일</option><option value=3>화요일</option><option value=4>수요일</option><option value=5>목요일</option><option value=6>금요일</option><option value=7>토요일</option><!-- input type = "text" name="sWeek"  size=1 --></select><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready3()"></td></tr>
</table>
</form>
<!--  준비화면 끝 -->
<%
