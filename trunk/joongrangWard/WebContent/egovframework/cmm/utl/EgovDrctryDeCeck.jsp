...
<table class="table-line">
    ...
    <tr>
        ...
        타겟경로<input type="text" name="baseDirPath2" >예) c:/data/home, /data/home<br>
        조건-시작일자<input type="text" name="fromDate2" >예) 20090101<br>
        조건-종료일자<input type="text" name="toDate2" >예) 20090131
        </td>
    </tr>
    <tr>
...
<table class="table-line">
    ...
    <tr>
        <td>
        기본경로이하의 디렉토리 중 생성일자(최종수정일자)가 조건범위 안에 포함되면 경로 출력, 존재하지 않으면 블랭크<br>
        타겟경로<input type="text" name="baseDirPath2" value="<%=baseDirPath2 %>">예) c:/data/home, /data/home<br>
        조건-시작일자<input type="text" name="fromDate2" value="<%=fromDate2 %>">예) 20090101<br>
        조건-종료일자<input type="text" name="toDate2" value="<%=toDate2 %>">예) 20090131<br>
