...
<table summary="제목, 작성자, 등록일, 조회수,첨부파일, 내용 제공" class="default_view">
    ...
    <tr>
        <td colspan="4" id="db_data_area">
			<img src="<c:url value='/cmm/fms/getImage.do'/>?atchFileId=<c:out value='${result.atchFileId}'/>&fileSn=0" alt="${result.nttSj} 사진" /><br />
			${fn:replace(result.nttCn, crlf, "<br />")}</td>
    </tr>
</table>
