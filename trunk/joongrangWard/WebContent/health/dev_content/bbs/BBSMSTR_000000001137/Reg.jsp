...
<input type="hidden" name="option1" value="${param.optionWrd}" />	
<input type="hidden" name="optionCnd" value="${param.optionCnd}" />	
<input type="hidden" name="optionWrd" value="${param.optionWrd}" />		
			
<table summary="감시활동 사전예고제 등록페이지로 제목, 작성자, 내용, 첨부파일로 구성" class="default_write">
    <caption>감시활동 사전예고제 등록</caption>
    <tr>
