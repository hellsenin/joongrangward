...
<table class="default_list" summary="번호, 제목, 담당부서, 등록일, 첨부파일, 조회수로 구성">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="tal"><a href="/health/bbs/selectBoardArticle.do?categoryId=${param.categoryId}&amp;bbsId=${param.bbsId}&amp;nttId=${result.nttId}&amp;pageIndex=${empty param.pageIndex ? 1 : param.pageIndex}"><c:out value="${result.nttSj}" /></a></td>
