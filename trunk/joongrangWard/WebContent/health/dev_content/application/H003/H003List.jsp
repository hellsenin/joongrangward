...
<table class="default_list" summary="결핵환자 발생신고 확인 페이지로 번호, 작성자, 신고인, 등록일, 처리상황으로 구성">
    <caption>결핵환자 발생신고 확인</caption>
    <thead>
        <tr>
            <th width="7%" scope="col">번호</th>
            <th width="13%" scope="col">작성자</th>
            <th width="37%" scope="col">신고인</th>
...
<div class="board_btn_set send_mg"> <span class="register"><a href="/health/application/writePage.do?applyCode=${param.applyCode}&amp;petiGubun=${param.petiGubun}&amp;categoryId=${param.categoryId}">신고하기</a></span> </div>
