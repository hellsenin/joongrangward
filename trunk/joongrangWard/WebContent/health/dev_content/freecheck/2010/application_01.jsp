	...
	<table summary="등록정보 테이블로 허가내용을 알 수 있습니다" class="default_view">
		...
		<tbody>
			...
			<tr>
				...
				<td class="output">
					<input id="addr2" type="text" name="addr2" style="width:200px;" class="t_text vam" value="${fn:replace(answer.ADDR2 == null ? Bean.addr2 : answer.ADDR2, '서울특별시 종로구 ', '')}" readonly="readonly" <c:if test="${Bean.view_state == 'readonly'}"> disabled='disabled'</c:if> alt="${answer.ADDR2 == null ? Bean.addr2 : answer.ADDR2}"/>
				</td>
				<th scope="row">
