					...
					<h2 class="text-indent">공지사항</h2>
						...
						<div id="tab_noticewapper03">
							...
							<ul id="tab_notice_03">
								...
								<li class="more">
									<a href="/health/bbs/selectBoardList.do?categoryId=3069&amp;bbsId=BBSMSTR_000000001150"><img src="/health/open_content/images/main/btn_more.gif" width="27" height="5" alt="의약게시판 더보기" /></a>
								</li>
							</ul>
						</div>
