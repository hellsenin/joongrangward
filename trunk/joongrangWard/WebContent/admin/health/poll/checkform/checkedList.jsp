...
function viewAnswer(master_cd, company_id) {
	location.href = "/admin/health/poll/forCheck.do?master_cd="+master_cd+"&company_id="+company_id;
};
...
function deleteResponse(masterCd, companyId)
{
	...
	{
		var url = "/admin/health/poll/checkform/checkedList/delete.do?master_cd="+masterCd+"&delete_company_id="+companyId;
		location.href = url;
	}
}
</script>
...
<div class="board_btn_set mt13">
	...
	<table class="default_view" summary="의약업소 자율점검 (점검표관리) 목록 테이블입니다">
...
<ol class="paging">${pagingInfoString}</ol>
			...
			<form action="/admin/health/poll/checkform/list.do" method="post" onsubmit="return checkAndSubmit(this);">
