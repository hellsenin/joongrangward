...
<form name="fm" method="post" action="<c:url value='/admin/health/poll/checkform/updateQuestion1.do'/>" enctype="multipart/form-data" onsubmit="return checkAndSubmit(this);">
