					...
					<table class="default_write">
						...
						<tr>
							...
							<td class="output" colspan="3">
								...
								<input type="text" id="eduEdate" name="eduEdate" class="board1" value="${result.eduEdate}" style="width:125px"/><a href="javascript:Calendar_D(frm.eduEdate)"><img src="/health/open_content/images/calendar.gif" class="vat" alt=""/></a>			
							</td>
						</tr>	
						<tr>
							<th scope="row">
								<label for="eduSdate">주설정(*)</label>
							</th>
							<td class="output" colspan="3">
								<input name="weekOfMonthData_A" type="checkbox" size="50" value='1' <c:if test="${fn:indexOf(result.weekOfMonth,'1') != -1}">checked</c:if> />1주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="weekOfMonthData_A" type="checkbox" size="50" value='2' <c:if test="${fn:indexOf(result.weekOfMonth,'2') != -1}">checked</c:if> />2주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="weekOfMonthData_A" type="checkbox" size="50" value='3' <c:if test="${fn:indexOf(result.weekOfMonth,'3') != -1}">checked</c:if> />3주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="weekOfMonthData_A" type="checkbox" size="50" value='4' <c:if test="${fn:indexOf(result.weekOfMonth,'4') != -1}">checked</c:if> />4주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;								
							</td>
						</tr>		
						<tr>
							<th scope="row">
								<label for="eduSdate">요일설정(*)</label>
							</th>
							<td class="output" colspan="3">
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='1' <c:if test="${fn:indexOf(result.dayOfWeek,'1') != -1}">checked</c:if> />일&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='2' <c:if test="${fn:indexOf(result.dayOfWeek,'2') != -1}">checked</c:if> />월&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='3' <c:if test="${fn:indexOf(result.dayOfWeek,'3') != -1}">checked</c:if> />화&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='4' <c:if test="${fn:indexOf(result.dayOfWeek,'4') != -1}">checked</c:if> />수&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='5' <c:if test="${fn:indexOf(result.dayOfWeek,'5') != -1}">checked</c:if> />목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='6' <c:if test="${fn:indexOf(result.dayOfWeek,'6') != -1}">checked</c:if> />금&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="dayOfWeekData_A" type="checkbox" size="50" value='7' <c:if test="${fn:indexOf(result.dayOfWeek,'7') != -1}">checked</c:if> />토&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</td>
						</tr>	
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td class="output" colspan="3">
								신청인원 <input type="text" id="appInwon" name="appInwon" class="board1" value="${result.appInwon}" style="width:125px" /> 명<br/>
								대기인원 <input type="text" id="waitInwon" name="waitInwon" class="board1" value="${result.waitInwon}" style="width:125px" /> 명
							</td>
						</tr>						
						<tr>
							<th scope="row">
