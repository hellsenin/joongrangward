...
<script type="text/javascript"> 
	...
	function fn_egov_regist_notice() {
		...
		if (document.board.option1.value==""){
				alert("\소재지 입력하세요.");
				return false;
		}
		if (document.board.option2.value==""){
				alert("\전화번호를 입력하세요.");
				return false;
		}
...
<h2 style="padding:15px 0 15px 0;">휴일야간진료</h2>
...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        <th scope="row" class="title_1"><label for="sr_title">업체명</label> </th>
        <td colspan="3" class="title_td"><input type="text" id="sr_title" name="nttSj" /></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="option1">소재지</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option1" name="option1" style="width:350px;"/></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="option2">전화번호</label> </th>
	...
	<tr>
        ...
        <td class="title_data"><input type="text" id="option3" name="option3" /></td>
