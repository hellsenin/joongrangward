...
<h2 style="padding:15px 0 15px 0;">위탁의료기관</h2>
...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        <th scope="row" class="title_1"><label for="sr_title">병/의원명</label> </th>
    ...
    <tr>
        <th scope="row" class="title"><label for="option1">전화번호</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option1" name="option1" style="width:200px;" value="${result.option1}"/></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="option2">주소</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option2" name="option2" style="width:400px;" value="${result.option2}"/></td>
    </tr>
	<tr>
        <th scope="row" class="title"><label for="option3">좌표 X</label> </th>
        <td class="title_data"><input type="text" id="option3" name="option3" style="width:100px;" value="${result.option4}"/></td>
        <th scope="row" class="title"><label for="option4">좌표 Y</label> </th>
        <td class="title_data"><input type="text" id="option4" name="option4" style="width:100px;" value="${result.option4}"/></td>
    </tr>
</table>
