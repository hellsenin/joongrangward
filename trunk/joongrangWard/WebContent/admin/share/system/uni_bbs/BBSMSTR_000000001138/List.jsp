...
<table class="default_list" summary="번호,제목, 작성자, 등록일, 첨부파일 구성">
    ...
    <thead>
        <tr>
            ...
            <th width="10%" scope="col">업종</th>
            <th width="28%" scope="col">상호명</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="http://gis.seoul.go.kr/SeoulGis/LifeMap_gu.jsp?Mode=4&OfficeName=금천구&SisulName=&RetSisulX=${result.option5}&RetSisulY=${result.option6}" target="_blank">지도</a></td>
        </tr>
...
<div class="board_btn_set send_mg" style="padding-top:15px;"> 
	<span class="btn_del"><a href="/admin/bbs/addBoardArticle.do?bbsId=${param.bbsId}">등록하기</a></span>
	<span class="btn_del"><a href="/health/bbs/forUploadExcel.do">엑셀등록</a></span>
</div>
