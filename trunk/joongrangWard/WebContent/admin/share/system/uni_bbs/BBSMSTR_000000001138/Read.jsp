...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_view">
    ...
    <tr>
        <th width="10%" class="title_1" scope="row">상호명</th>
	...
	<tr>
        <th width="10%" scope="row">주소</th>
        <td colspan="3"><p><c:out value="${result.option2}" /></p></td>
    </tr>
	<tr>
        <th width="10%" scope="row">연락처</th>
        <td colspan="3"><p><c:out value="${result.option3}" /></p></td>
    </tr>
	<tr>
        <th scope="row"><label for="option5">X좌표</label> </th>
        <td><c:out value="${result.option5}" /></td>
		<th scope="row"><label for="option6">Y좌표</label> </th>
