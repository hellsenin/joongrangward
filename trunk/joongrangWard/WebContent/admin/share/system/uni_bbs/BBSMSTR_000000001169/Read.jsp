...
<input type="hidden" name="optionCnd" value="<c:out value='${param.optionCnd}'/>" />
<input type="hidden" name="optionWrd" value="<c:out value='${param.optionWrd}'/>" />
...
<div class="board_btn_set mt13">
	<span class="btn_del"><a href="/admin/bbs/forUpdateBoardArticle.do?bbsId=${param.bbsId}&amp;nttId=${result.nttId}&amp;optionCnd=option2&amp;optionWrd=${param.optionWrd}">수정하기</a></span>
