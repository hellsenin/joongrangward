...
@Controller
public class BtnMainController implements ServletContextAware {
	...
	@RequestMapping("/btn/main/main.do")
	public String main(
			...
			ModelMap model)throws Exception
	{
    	...
    	return "btn/open_content/main/btnMain";
	}
	
	@RequestMapping("/btn/main/contents.do")
			...
			ModelMap model) throws Exception 
	{
		...
		HashMap<String, ZValue> btnMenuMap = (HashMap<String, ZValue>)servletContext.getAttribute("btnMenuMap");
		ZValue currMenuZvl = btnMenuMap.get("menu_" + categoryId);
		...
		return "btn/open_content/main/btnIndex";
	}
