...
@Controller
public class JapaneseMainController implements ServletContextAware {
	...
	@RequestMapping("/japanese/main/main.do")
	public String main(
			...
			ModelMap model)throws Exception
	{
    	...
    	return "japanese/open_content/main/japaneseMain";
	}
	
	@RequestMapping("/japanese/main/contents.do")
			...
			ModelMap model) throws Exception 
	{
		...
		HashMap<String, ZValue> japaneseMenuMap = (HashMap<String, ZValue>)servletContext.getAttribute("japaneseMenuMap");
		ZValue currMenuZvl = japaneseMenuMap.get("menu_" + categoryId);
		...
		return "japanese/open_content/main/japaneseIndex";
	}
