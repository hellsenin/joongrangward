...
@Controller
public class ChinaMainController implements ServletContextAware {
	...
	@RequestMapping("/china/main/main.do")
	public String main(
			...
			ModelMap model)throws Exception
	{
    	...
    	return "china/open_content/main/chinaMain";
	}
	
	@RequestMapping("/china/main/contents.do")
			...
			ModelMap model) throws Exception 
	{
		...
		HashMap<String, ZValue> chinaMenuMap = (HashMap<String, ZValue>)servletContext.getAttribute("chinaMenuMap");
		ZValue currMenuZvl = chinaMenuMap.get("menu_" + categoryId);
		...
		return "china/open_content/main/chinaIndex";
	}
