	...
	public static String getMyMACAddress(String localIP)
	{
		...
		try { 
			if ("WINDOWS".equals(Globals.OsType)) {
				...
				in.close(); 
				if(out == null || out.indexOf("MAC Address = ") == -1 ){ throw new Exception("String Split Error!"); }
	...
	public static List<String > getMyPortScan()
	{
		...
		try { 
			...
			if ("WINDOWS".equals(Globals.OsType)) {
				...
				String cmdStr = EgovProperties.getProperty(Globals.ServerConfPath, "SHELL."+Globals.OsType+".getNetWorkInfo");
