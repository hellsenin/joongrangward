...
//	community.setFrstRegisterId(user.getUniqId());
    ...
    public String selectCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
	...
	// 제공 URL 
	//-----------------------
	vo.setProvdUrl("/cop/cmy/CmmntyMainPage.do?cmmntyId=" + vo.getCmmntyId());
	////---------------------

	model.addAttribute("cmmntyVO", vo);
	model.addAttribute("result", map.get("resultList"));

	return "cop/cmy/EgovCmmntyInqire";
    }
...
//	community.setLastUpdusrId(user.getUniqId());
	...
	return "cop/cmy/EgovCmmntyListPortlet";
    }
...
//	cmmntyVO.setEmplyrId(user.getUniqId());
	...
	if ("".equals(tmplatCours) || tmplatCours == null) {
	    tmplatCours = "/cop/com/template/EgovCmmntyBaseTmpl";
	}
	Map<String, Object> map = cmmntyService.selectCommunityInf(cmmntyVO);
...
//	cmmntyVO.setEmplyrId(user.getUniqId());
	...
	return "cop/com/template/EgovCmmntyBaseTmplContents";
    }
...
//		history.setConfmRqesterId(user.getUniqId()); 		// 요청자 ID
	...
	return "cop/cmy/EgovCmmntyListPop";
    }
