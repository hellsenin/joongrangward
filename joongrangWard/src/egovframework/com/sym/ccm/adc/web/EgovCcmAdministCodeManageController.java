...
public class EgovCcmAdministCodeManageController {
	...
	public String deleteAdministCode (AdministCode administCode
			, ModelMap model
			) throws Exception {
	...
	public String insertAdministCode (@ModelAttribute("administCode") AdministCode administCode
...
//			administCode.setFrstRegisterId(loginVO.getUniqId());
	...
	@RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeDetail.do")
 	public String selectAdministCodeDetail (AdministCode administCode
 			, ModelMap model
 			) throws Exception {
	...
	public String selectAdministCodeList (@ModelAttribute("searchVO") AdministCodeVO searchVO
			, ModelMap model
			) throws Exception {
	...
	public String selectAdministCode (@ModelAttribute("searchVO") AdministCodeVO searchVO
			, ModelMap model
			) throws Exception {
    	/** EgovPropertyService.sample */
    	searchVO.setPageUnit(propertiesService.getInt("pageUnit"));
	...
	public String updateAdministCode (@ModelAttribute("administCode") AdministCode administCode
			, BindingResult bindingResult
			, Map commandMap
			, ModelMap model
			) throws Exception {
