...
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form:form commandName="qustnrTmplatManageVO" name="qustnrTmplatManageVO" action="/uss/olp/qtm/EgovQustnrTmplatManageModifyActor.do" method="post" enctype="multipart/form-data">
<!-- ----------------- 상단 타이틀  영역 -->
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;설문템플릿 수정</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    ...
    <td>
      <form:input path="qestnrTmplatTy" size="70" cssClass="txaIpt"/>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
    	...
    	<tr>
    	<td><input type="file" name="qestnrTmplatImagepathnm" onChange="fnImgChange(this)"></td>
    	<td>
	     	<c:if test="${resultList[0].qestnrTmplatImagepathnm ne null}">
	      	<c:if test="${resultList[0].qestnrTmplatImagepathnm ne ''}">
	    	<img src="/uss/olp/qtm/EgovQustnrTmplatManageImg.do?qestnrTmplatId=${resultList[0].qestnrTmplatId}" id="IMG_VIEW" name="IMG_VIEW" align="absmiddle" onLoad="if(this.width>65){this.width=65}">
	    	</c:if>
			</c:if>
	     </td>
	     </tr>
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
    		<textarea name="qestnrTmplatCn" class="textarea"  cols="75" rows="8"  style="width:100%;" value="">${resultList[0].qestnrTmplatCn}</textarea>    		
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
    <form:input path="qestnrTmplatCours" size="10" cssClass="txaIpt"/>
