...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="/images/egovframework/uss/olp/cns/icon/tit_icon.gif" width="16" height="16" hspace="3" align="left">&nbsp;상담 등록</td>
 </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    ...
    <td width="80%" nowrap>
        <form:password path="writngPassword" size="20" maxlength="20" />
  ...
  <tr> 
    ...
    <td> 
		<input name="firstMoblphonNo" 		type="text" size="5"  maxlength="5">-
		<input name="middleMbtlnum" 		type="text" size="5"  maxlength="5">-
		<input name="endMbtlnum" 			type="text" size="5"  maxlength="5">               
    </td>
  </tr> 
  ...
  <tr> 
    ...
    <td> 
		...
		<input name="emailAnswerAt" type="checkbox" value="Y"> 이메일답변여부               
    </td>
  </tr> 
...
<tr> 
  ...
  <td background="/images/egovframework/uss/olp/cns/button/bu2_bg.gif" class="text_left" nowrap>
  		<a href="JavaScript:fn_egov_regist_cnsltdtls(document.forms[0]);">저장</a> 
  </td>
