...
function fn_egov_save_MeetingManage(){
	...
	if(confirm("저장 하시겠습니까?")){
		varFrom.action =  "/uss/olp/mgt/EgovMeetingManageRegist.do";
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="/images/egovframework/uss/olp/mgt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;회의정보 등록</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr> 
    ...
    <td width="80%" nowrap>
     	<input name="mtgNm" type="text" size="73" value="${resultList[0].mtgNm}" maxlength="250" style="width:100%;">
  ...
  <tr> 
    ...
    <td>
      <textarea name="mtgMtrCn" class="textarea"  cols="75" rows="4"  style="width:100%;" value=""></textarea>
  ...
  <tr> 
    ...
    <td>
      <input name="mtgSn" type="text" size="73" value="" maxlength="10" style="width:60px;">
  ...
  <tr> 
    ...
    <td>
      <input name="mtgCo" type="text" size="73" value="" maxlength="5" style="width:60px;">
  ...
  <tr> 
    ...
    <td>
      <input name="mtgDe" id="mtgDe" type="text" size="73" value="" maxlength="10" style="width:80px;" readOnly>
  ...
  <tr> 
    ...
    <td>
      <input name="mtgPlace" type="text" size="73" value="" maxlength="250" style="width:200px;">  
  ...
  <tr> 
    <th height="23" class="required_text" >비공개 회의여부</th>
    <td>
     <input name="clsdrMtgAt" type="checkbox" style="border:0px;" value="1" checked>
    </td>
  </tr> 
  ...
  <tr> 
    ...
    <td>
      <input name="readngBeginDe" id="readngBeginDe" type="text" size="73" value="" maxlength="10" style="width:80px;" readOnly>
  ...
  <tr> 
    <th height="23" class="required_text" >열람 여부</th>
    <td>
  ...
  <tr> 
    ...
    <td>
      <textarea name="mtgResultCn" class="textarea"  cols="75" rows="4"  style="width:100%;" value=""></textarea> 
    </td>
  </tr>
  ...
  <tr> 
    ...
    <td>
     <input name="mtgResultEnnc" type="checkbox" style="border:0px;" value="1" checked>
    </td>
  </tr> 
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;">기타 사항</DIV></th>
    <td>
      <textarea name="etcMatter" class="textarea"  cols="75" rows="2"  style="width:100%;" value=""></textarea> 
    </td>
  </tr>
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;">주관부서</DIV></th>
    <td>
      <input name="mngtDeptNm" id="mngtDeptNm" type="text" size="73" value="" maxlength="2000" style="width:100px;" readOnly>
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;">주관자명</DIV></th> 
    <td>
      <input name="mnaerNm" id="mnaerNm" type="text" size="73" value="" maxlength="2000" style="width:100px;" readOnly>
  ...
  <tr> 
    ...
    <td>
      <input name="mnaerDeptNm" id="mnaerDeptNm" type="text" size="73" value="" maxlength="2000" style="width:100px;" readOnly>
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;">불참석자수</DIV></th>
    <td>
      <input name="nonatdrnCo" id="nonatdrnCo" type="text" size="73" value="" maxlength="10" style="width:60px;">  
    </td>
  </tr> 
  <tr> 
    <th height="23" class="required_text" >
    ...
    <td>
      <input name="atdrnCo" id="atdrnCo" type="text" size="73" value="" maxlength="10" style="width:60px;">  
    </td>
  </tr>
<!--
  <tr> 
