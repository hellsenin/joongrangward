...
function fn_egov_statistics_QustnrQestnManage(qestnrQesitmId){
	var vFrom = document.listForm;
	vFrom.qestnrQesitmId.value = qestnrQesitmId;
	vFrom.action = "/uss/olp/qqm/EgovQustnrQestnManageStatistics.do"; 
	vFrom.submit();
}
  ...
  <th width="70px" align="center">
   <table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      ...
      <td background="<c:out value="${ImgUrl}"/>button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_regist_QustnrQestnManage();"><spring:message code="button.create" /></a> 
      </td>
      <td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20"></td>
      <td>&nbsp;</td>  
    </tr>
...
<table width="100%" cellpadding="0" class="table-line">
 <thead>
  <tr>  
    ...
    <th class="title" width="70px" nowrap>질문유형</th>
    <th class="title" width="70px" nowrap>질문항목</th>
...
<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
  <tr>
    ...
    <div class="divDotText" style="width:330px; border:solid 0px;"><a href="javaScript:fn_egov_detail_QustnrQestnManage('${resultInfo.qestnrQesitmId}');">${resultInfo.qestnCn}</a></div>
    </td>
    <td class="lt_text3" nowrap>
    <c:if test="${resultInfo.qestnTyCode == '1'}">객관식</c:if>
    <c:if test="${resultInfo.qestnTyCode == '2'}">주관식</c:if>
    </td>
    <td class="lt_text3" nowrap><a href="/uss/olp/qim/EgovQustnrItemManageList.do?searchMode=Y&qestnrQesitmId=${resultInfo.qestnrQesitmId}">보기</a></td>
    <td class="lt_text3" nowrap><a href="javaScript:fn_egov_statistics_QustnrQestnManage('${resultInfo.qestnrQesitmId}');">보기</a></td>
