...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        ...
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/uss/umt/entrprs/EgovEntrprsMberDelete.do'/>";
...
function fnSelectUser(id) {
    ...
    document.listForm.action = "<c:url value='/uss/umt/entrprs/EgovEntrprsMberSelectUpdtView.do'/>";
    document.listForm.submit();
      
}
function fnAddUserView() {
	document.listForm.action = "<c:url value='/uss/umt/entrprs/EgovEntrprsMberInsertView.do'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/uss/umt/entrprs/EgovEntrprsMberManage.do'/>";
    document.listForm.submit();
}
function fnSearch(){
...
<body>
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;기업회원관리</td>
            </tr>
        </table>
        <!-- content start -->
        <form name="listForm" action="javascript:fnSearch();" method="post">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td background="/images/egovframework/cmm/uss/umt/button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fnSearch();"><spring:message code="button.search" /></a></td>
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" width="8" height="20"></td>
                <td>&nbsp;</td>
                <!-- 삭제 -->
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" width="8" height="20"></td>
                <td background="/images/egovframework/cmm/uss/umt/button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fnDeleteUser();"><spring:message code="button.delete" /></a></td>
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" width="8" height="20"></td>      
                <td>&nbsp;</td>
                <!-- 목록 -->
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" width="8" height="20"></td>
                <td background="/images/egovframework/cmm/uss/umt/button/bu2_bg.gif" class="text_left" nowrap><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsMberManage.do'/>"><spring:message code="button.list" /></a></td>
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" width="8" height="20"></td>
                <td>&nbsp;</td>
                <!-- 등록 -->
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" width="8" height="20"></td>
                <td background="/images/egovframework/cmm/uss/umt/button/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fnAddUserView();"><spring:message code="button.create" /></a></td>
                <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" width="8" height="20"></td>
        ...
        <table summary="List of User"  width="717" cellpadding="8" class="table-line">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="lt_text3" style="cursor:pointer;cursor:hand" ><span onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>')"><c:out value="${result.userId}"/></span></td>
