...
<table width="430" border="0" cellpadding="0" cellspacing="1" class="table-register">
	<tr>
      <th width="150" height="23" class="required_text" nowrap>파일(디렉토리) 압축</th>
      <td width="280" height="23" class="title_left" nowrap><input type = "button" method="post"  value="실행!" onclick="cmprsForm.submit()"></td>
    </tr>
    <tr>
      <th width="150" height="23" class="title_left" nowrap>원본파일</td>
      <td width="280" height="23" class="title_left" nowrap><input type = "text" name="source" value="" size="40"></td>
    </tr>
	<tr>
      <th width="150" height="23" class="title_left" nowrap>압축파일</td>
...
<table width="430" border="0" cellpadding="0" cellspacing="1" class="table-register">
	<tr>
      <th width="150" height="23" class="required_text" nowrap>파일(디렉토리) 압축해제</th>
      <td width="280" height="23" class="title_left" nowrap><input type = "button" method="post"  value="실행!" onclick="decmprsForm.submit()"></td>
    </tr>
    <tr>
      <th width="150" height="23" class="title_left" nowrap>압축파일</td>
      <td width="280" height="23" class="title_left" nowrap><input type = "text" name="source" value="" size="40"></td>
	...
	<tr>
      <th width="150" height="23" class="title_left" nowrap>해제경로</td>
      <td width="280" height="23" class="title_left" nowrap><input type = "text" name="target" value="" size="40"></td>
    </tr>
</table>
</form>
