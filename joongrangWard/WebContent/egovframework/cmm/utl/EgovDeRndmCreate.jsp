...
<table border="1">
	...
	<tr><td>시작날짜(yyyyMMdd):</td><td><input type = "text" name="startDate"  size=10></td></tr>
	<tr><td>종료날짜(yyyyMMdd):</td><td><input type = "text" name="endDate"  	size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready()"></td></tr>
</table>
</form>
<!--  준비화면 끝 -->
<%
