...
<table border="1">
	<tr><td>      기능설명:</td><td>입력된 일자를 String으로 변경 <br></td></tr>
 	<tr><td>일자(yyyyMMdd):</td><td><input type = "text" name="sDate"  size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready1()"></td></tr> 
</table>
</form>
<!--  준비화면 끝 -->
<%	
...
<table border="1">
	<tr><td>      기능설명:</td><td>입력된 시간을 String으로 변경 <br></td></tr>
 	<tr><td>    시간(HHmm):</td><td><input type = "text" name="sTime"  size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready2()"></td></tr> 
</table>
</form>
<!--  준비화면 끝 -->
<%	
...
<table border="1">
	<tr><td>        기능설명:</td><td>입력된 일자를 int 로 변경 <br></td></tr>
 	<tr><td>일자(yyyy-MM-dd):</td><td><input type = "text" name="sDate"  size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready3()"></td></tr> 
</table>
</form>
<!--  준비화면 끝 -->
<%	
...
<table border="1">
	<tr><td>       기능설명:</td><td>입력된 시간을 Int 로 변경 <br></td></tr>
 	<tr><td>    시간(HH:mm):</td><td><input type = "text" name="sTime"  size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready4()"></td></tr> 
</table>
</form>
<!--  준비화면 끝 -->
<%	
