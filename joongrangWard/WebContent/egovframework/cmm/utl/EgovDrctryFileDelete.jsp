...
* @author    JJY
*******************************************************  --%>
<link rel="stylesheet" href="/css/egovframework/cmm/utl/com.css" type="text/css">
...
%>
<script type="text/javascript" src="/js/egovframework/cmm/utl/EgovCmmUtl.js" ></script>
<!-- 준비화면  시작-->
...
<table class="table-line">
    ...
    <tr>
        ...
        삭제경로<input type="text" name="dirDeletePath" >예) c:/data/home/dir1, /data/home/dir1<br>
        </td>
    </tr>
    <tr>
        <td>
        삭제할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 삭제<br>
        삭제할 디렉토리가 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="dirDeletePath3" >예) c:/data/home/dir1, /data/home/dir1<br>
        삭제조건-생성일자-시작일<input type="text" name="fromDate3" >예) 20090101<br>
        삭제조건-생성일자-종료일<input type="text" name="toDate3" >예) 20090228<br>
        </td>
    </tr>
    <tr>
        <td>
        삭제할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 삭제<br>
        삭제할 디렉토리가 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="dirDeletePath4" >예) c:/data/home/dir1, /data/home/dir1<br>
        삭제조건-생성자<input type="text" name="owner4" >예) user01<br>
        </td>
    </tr>
    <tr>
        <td>
        ...
        삭제경로<input type="text" name="fileDeletePath" >예) c:/data/home/file1.txt, /data/home/file1.txt<br>
        </td>
    </tr>
    <tr>
...
<table class="table-line">
    ...
    <tr>
        ...
        삭제할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 삭제<br>
        삭제할 디렉토리가 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="dirCreationPath" value="<%=dirDeletePath %>">예) c:/data/home/dir1, /data/home/dir1<br>
        결과 : <%=result1 %>
        </td>
    </tr>
    <tr>
        ...
        삭제할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 삭제<br>
        삭제할 디렉토리가 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="dirDeletePath3" value="<%=dirDeletePath3 %>">예) c:/data/home/dir1, /data/home/dir1<br>
        삭제조건-생성일자-시작일<input type="text" name="fromDate3" value="<%=fromDate3 %>">예) 20090101<br>
        삭제조건-생성일자-종료일<input type="text" name="toDate3" value="<%=toDate3 %>">예) 20090228<br>
        결과 : <%=result3 %>
        </td>
    </tr>
    <tr>
        ...
        삭제할 디렉토리의 절대경로를 입력하면 해당되는 디렉토리를 삭제<br>
        삭제할 디렉토리가 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="dirDeletePath4" value="<%=dirDeletePath4 %>">예) c:/data/home/dir1, /data/home/dir1<br>
        삭제조건-생성자<input type="text" name="owner4" value="<%=owner4 %>">예) user01<br>
        결과 : <%=result4 %>
        </td>
    </tr>  
    <tr>
        ...
        삭제할 파일의 절대경로를 입력하면 해당되는 파일를 삭제<br>
        기존에 파일이 비존재하는 경우 별도 작업 없이 블랭크를 리턴<br>
        삭제경로<input type="text" name="fileCreationPath" value="<%=fileDeletePath %>">예) c:/data/home/file1.txt, /data/home/file1.txt<br>
        결과 : <%=result2 %>
        </td>
    </tr>
    <tr>
