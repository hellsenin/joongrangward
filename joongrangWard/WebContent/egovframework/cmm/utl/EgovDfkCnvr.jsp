...
<table border="1">
	<tr><td>      기능설명:</td><td>입력된 일자를 포멧스트링 형태로 변경 </td>
 	...
 	<tr>
 		...
 		<td>
		 	<input type = "text" name="sFormatStr"  size=30 value='yyyy-MM-dd'>
...
<table border="1">
	<tr><td>      기능설명:</td><td>입력된 시간을 포멧스트링 형태로 변경 <br></td></tr>
 	<tr>
 		<td>시간(HHmm):</td>
 		<td>
		 	<input type = "text" name="sTime"  size=10>
 		</td>
 	</tr> 
 	<tr>
 		<td>포멧스트링(yyyy-MM-dd):</td>
 		<td>
		 	<input type = "text" name="sFormatStr"  size=30 value='HH:mm'>
...
<table border="1">
	<tr><td>기능설명:</td><td>입력된 요일을 한글 요일로 변경하는 기능</td></tr>
 	<tr><td>요일(SUN, MON, ..., SAT):</td><td><input type = "text" name="sWeek"  size=10><input type = "button" method="post"  value="실행!" onclick="javascript:fn_ready3()"></td></tr> 
</table>
</form>
<!--  준비화면 끝 -->
<%
