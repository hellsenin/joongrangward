...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="/images/egovframework/cmm/sym/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;행정코드 등록</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr> 
    ...
    <td width="80%" nowrap>
      <select id="administZoneSe" name="administZoneSe" onChange="javascript:fn_egov_Administ_Zone_Change()">
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <form:input  path="administZoneCode" size="10" maxlength="10"/>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <input  name="upperAdministZoneNm" size="60" maxlength="60" readonly onClick="javascript:fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm);"/>
...
<tr> 
  ...
  <td background="/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="JavaScript:javascript:fn_egov_regist_AdministCode(document.administCode);">저장</a></td>
