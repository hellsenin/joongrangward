 ...
 ******************************************************** */
function fnRegist(){
	location.href = "/sym/ccm/cde/EgovCcmCmmnDetailCodeRegist.do";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="/images/egovframework/cmm/sym/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;공통상세코드 목록</td>
  <th>
  </th>
  <td width="10%">
...
<tr>  
	...
	<th class="title" width="20%" nowrap>코드ID</th>
	<th class="title" width="30%" nowrap>코드</th>
	<th class="title" width="30%" nowrap>코드명</th>
