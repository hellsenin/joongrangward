...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="/images/egovframework/cmm/sym/cal/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;휴일 목록</td>
  <th>
  </th>
  <td width="10%">
  ...
  <th width="10%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><img src="/images/egovframework/cmm/sym/cal/btn/bu2_left.gif" alt="조회" width="8" height="20"></td>
      <td background="/images/egovframework/cmm/sym/cal/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_search_Restde();">조회</a></td>
      <td><img src="/images/egovframework/cmm/sym/cal/btn/bu2_right.gif" alt="조회" width="8" height="20"></td>
      <td width="10"></td>

      <td><img src="/images/egovframework/cmm/sym/cal/btn/bu2_left.gif" alt="등록" width="8" height="20"></td>
      <td background="/images/egovframework/cmm/sym/cal/btn/bu2_bg.gif" class="text_left" nowrap><a href="javascript:fn_egov_regist_Restde();">등록</a></td>
      <td><img src="/images/egovframework/cmm/sym/cal/btn/bu2_right.gif" alt="등록" width="8" height="20"></td>
    </tr>
   </table>
  </th>  
 </tr>
