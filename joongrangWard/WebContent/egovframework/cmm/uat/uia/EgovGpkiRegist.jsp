...
<body>
  <!--인증서등록 테이블 시작-->
  <form name="GpkiLoginForm" action ="<c:url value='/uat/uia/actionGpkiRegist.action'/>" method="post">
<table width="303" border="0" cellspacing="8" cellpadding="0">
     <tr height="10">
     </tr>
     <tr>
	<td width="40%"class="title_left"><img src="/images/egovframework/cmm/uat/uia/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;인증서 DN 추출</td>
     </tr>
     <tr>
		...
		<table>
		  <tr>
			  ...
			  <tr>
				...
				<td background="/images/egovframework/cmm/uat/uia/bu2_bg.gif" class="text_left" nowrap><center><a href="javascript:LoginEmbedded(document.GpkiLoginForm);">DN값 추출</a></center></td>
              ...
              <tr>
		       ...
		       <td><img src="/images/egovframework/cmm/uat/uia/bu2_left.gif" width="8" height="20"></td>
		       <td background="/images/egovframework/cmm/uat/uia/bu2_bg.gif" class="text_left" nowrap><center><a href="javascript:sendDn();">DN값 전달</a></center></td>
		       <td><img src="/images/egovframework/cmm/uat/uia/bu2_right.gif" width="8" height="20"></td>  
	          </tr>
            </table> 
		  </tr>
