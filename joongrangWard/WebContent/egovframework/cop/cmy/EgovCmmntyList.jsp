...
<script type="text/javascript">
	...
	function fn_egov_insert_addCmmntyInf(){
		document.frm.action = "<c:url value='/cop/cmy/addCmmntyInf.do'/>";
		document.frm.submit();
	}
	
	function fn_egov_inqire_cmmntyInf(cmmntyId){
		document.frm.cmmntyId.value = cmmntyId;
		document.frm.action = "<c:url value='/cop/cmy/selectCmmntyInf.do'/>";
		document.frm.submit();		
	}
</script>
<title>커뮤니티 목록</title>
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	      ...
	      <td><img src="<c:url value='/images/egovframework/cop/bbs/btn/bu2_left.gif'/>" width="8" height="20" alt="button left"></td>
	      <td background="<c:url value='/images/egovframework/cop/bbs/btn/bu2_bg.gif'/>" class="text_left" nowrap>
	      <a href="javascript:fn_egov_insert_addCmmntyInf()">등록</a> 
	      </td>
	      <td><img src="<c:url value='/images/egovframework/cop/bbs/btn/bu2_right.gif'/>" width="8" height="20" alt="button right"></td>    
	    </tr>
	   </table>
	...
	<table width="100%" cellpadding="8" class="table-line">
	 <thead>
	  <tr>
	    ...
	    <th class="title" width="47%" nowrap>커뮤니티명</th>
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
		    	<a href="javascript:fn_egov_inqire_cmmntyInf('<c:out value="${result.cmmntyId}"/>')">
		    	<c:out value="${result.cmmntyNm}"/></a>
		    </td>
