...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  ...
	  <img src="<c:url value='/images/egovframework/cop/clb/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="title icon">
	   &nbsp;동호회 정보수정</td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  ...
	  <tr> 
	    ...
	    <td width="80%" nowrap colspan="3">
	      <input name="clbNm" type="text" size="60" value='<c:out value="${clubVO.clbNm}" />' maxlength="60" style="width:100%">
	  ...
	  <tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/clb/icon/required.gif' />" width="15" height="15" alt="required"></th>
	    <td colspan="3">
	      <textarea name="clbIntrcn" class="textarea"  cols="75" rows="4" style="width:100%"><c:out value="${clubVO.clbIntrcn}" /></textarea> 
	  ...
	  <tr> 
	    ...
	    <input name="tmplatNm" type="text" size="20" value='<c:out value="${clubVO.tmplatNm}" />'  maxlength="20" readonly >
	  ...
	  <tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/clb/icon/required.gif' />" width="15" height="15"></th>
	    <td width="30%" nowrap colspan="3">
	    <input name="emplyrId" type="hidden" value='<c:out value="${clubUser.emplyrId}" />' />
	    <input name="emplyrNm" type="text" size="20" value='<c:out value="${clubUser.emplyrNm}" />' maxlength="20" readonly >
	     &nbsp;<a href="javascript:fn_egov_inqire_cmmntyUser('<c:out value="${clubVO.clbId}" />');" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	     			width="15" height="15" align="absmiddle" alt="search"></a>
