...
<script type="text/javascript">
	//<![CDATA[
	function fn_egov_update_notice(form)
	{			
...
<div class="body">
<form name="board" action="/health/bbs/updateBoardArticle.do" method="post" enctype="multipart/form-data" onsubmit="return fn_egov_update_notice(this);">
...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        ...
        <td colspan="3" class="title_td"><input type="hidden" id="sr_title" name="nttSj" value="${result.nttSj}" />${result.nttSj}</td>
    </tr>
    <tr>
