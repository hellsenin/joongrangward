...
<div class="board_top clearfix">
    ...
    <fieldset class="fl_r">
        ...
        <input type="text" class="text" name="searchWrd" id="searchWrd" value='<c:out value="${searchVO.searchWrd}"/>' />
    <input type="image" src="/health/open_content/images/borad/btn_search.gif" alt="검색" />
    </fieldset>
</div>
</form>

<table class="default_list" summary="건강동영상 게시판으로 번호,제목, 작성자, 등록일, 첨부파일, 조회수로 구성">
    <caption>건강동영상</caption>
    <thead>
        <tr>
        ...
        <tr>
            ...
            <td>
            	<c:if test="${result.fileNm != null}">
					<a href="/cmm/fms/FileDown.do?atchFileId=<c:out value='${result.atchFileId}'/>&fileSn=<c:out value='${result.fileSeq}'/>"><img src="http://www.geumcheon.go.kr/open_content/images/common/icon/icon_form.gif" alt="${result.nttSj} 첨부파일" /></a>
				</c:if>
            </td>
