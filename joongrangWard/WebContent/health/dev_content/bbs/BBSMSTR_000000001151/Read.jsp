...
<table summary="제목, 등록일, 조회수, 담당부서, 내용, 첨부파일 제공" class="default_view">
...
<div class="board_btn_set mt13">
    <span class="btn_list"><a href="/health/bbs/selectBoardList.do?categoryId=${param.categoryId}&amp;bbsId=${param.bbsId}&amp;pageIndex=${empty param.pageIndex ? 1 : param.pageIndex}">목록보기</a></span>
</div>
