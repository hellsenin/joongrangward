...
<br />
<h5>신고내용</h5>
<table summary="결핵환자 발생신고 페이지로 신고인, 신고내용, 첨부파일, 전화번호,  주소, 처리결과 회신으로 구성" class="default_write">
    <caption>결핵환자 발생신고</caption>
...
<div class="board_btn_set mt13">
    ...
    <span class="btn_del"><a href="/health/main/contents.do?categoryId=2933">취소하기</a></span>
</div>
</form>
