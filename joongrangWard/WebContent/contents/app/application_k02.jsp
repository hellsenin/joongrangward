	...
	<table summary="허가정보 테이블로 허가내용을 알 수 있습니다" class="default_view">
		...
		<tbody>
			...
			<tr>
				...
				<td class="output" colspan="2"><input type="text" id="addr2" name="addr2" value="${fn:replace(answer.ADDR1 == null ? Bean.addr1 : answer.ADDR1, '서울특별시 금천구 ', '')}" style="width:210px;" class="t_text" <c:if test="${Bean.view_state == 'readonly'}"> disabled='disabled'</c:if>/></td>
