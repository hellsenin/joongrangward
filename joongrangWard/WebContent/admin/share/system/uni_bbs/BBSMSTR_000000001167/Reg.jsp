...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        ...
        <td colspan="3" class="title_data"><input type="text" id="option1" name="option1" style="width:200px;"/></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="option2">주소</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option2" name="option2" style="width:400px;"/></td>
    </tr>
	<tr>
        <th scope="row" class="title"><label for="option3">좌표 X</label> </th>
        <td class="title_data"><input type="text" id="option3" name="option3" style="width:100px;"/></td>
        <th scope="row" class="title"><label for="option4">좌표 Y</label> </th>
        <td class="title_data"><input type="text" id="option4" name="option4" style="width:100px;"/></td>
    </tr>
</table>
