...
<table class="default_list" summary="번호,제목, 작성자, 등록일, 첨부파일 구성">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="tal"><a href="/admin/bbs/selectBoardArticle.do?bbsId=${param.bbsId}&amp;nttId=${result.nttId}&amp;optionCnd=option2&amp;optionWrd=${param.optionWrd}"><c:out value="${result.nttSj}" /></a></td>
...
<div class="board_btn_set send_mg" style="padding-top:15px;"> 
	<span class="register">
		<a href="/admin/bbs/addBoardArticle.do?bbsId=${param.bbsId}&amp;optionCnd=option2&amp;optionWrd=${param.optionWrd}">등록하기</a>
	</span>
</div>
