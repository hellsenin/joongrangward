...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
	...
	<tr>
        ...
        <td colspan="2" class="title_data"><input type="text" id="option3" name="option3" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option4">국</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option4" name="option4" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option5">반찬1</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option5" name="option5" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option6">반찬2</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option6" name="option6" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option7">반찬3</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option7" name="option7" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option8">반찬4</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option8" name="option8" /></td>
    </tr>
	<tr>
        <th scope="row" rowspan="6" class="title">점심 </th>
		<th scope="row" class="title"><label for="option9">밥</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option9" name="option9" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option10">국</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option10" name="option10" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option11">반찬1</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option11" name="option11" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option12">반찬2</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option12" name="option12" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option13">반찬3</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option13" name="option13" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option14">반찬4</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option14" name="option14" /></td>
    </tr>
	<tr>
        <th scope="row" rowspan="6" class="title">저녁 </th>
		<th scope="row" class="title"><label for="option15">밥</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option15" name="option15" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option16">국</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option16" name="option16" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option17">반찬1</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option17" name="option17" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option18">반찬2</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option18" name="option18" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option19">반찬3</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option19" name="option19" /></td>
    </tr>
	<tr>
		<th scope="row" class="title"><label for="option20">반찬4</label> </th>
        <td colspan="2" class="title_data"><input type="text" id="option20" name="option20" /></td>
    </tr>
</table>
