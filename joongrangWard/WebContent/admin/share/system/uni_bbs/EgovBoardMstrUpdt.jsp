	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/bbs/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="title icon">&nbsp;게시판 정보수정</td>
	 </tr>
	</table>
...
<!--   <tr> 
  	...
  	<tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/bbs/icon/required.gif' />" width="15" height="15" alt="required"></th>
	    <td width="30%" nowrap colspan="3" >
	     	<spring:message code="button.possible" /> : <input type="radio" name="commentPosblAt" class="radio2" value="Y" <c:if test="${result.commentPosblAt == 'Y'}"> checked="checked"</c:if>>&nbsp;
	     	<spring:message code="button.impossible" /> : <input type="radio" name="commentPosblAt" class="radio2" value="N" <c:if test="${result.commentPosblAt == 'N'}"> checked="checked"</c:if>>
...
<!--  <tr> 
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="javascript:fn_egov_inqire_tmplatInqire();"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	...
	<tr> 
	  <td><img src="./img/button/bu2_right.gif" width="8" height="20"></td>     
