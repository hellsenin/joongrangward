...
<script type="text/javascript">
	...
	function fn_egov_select_brdMstr(pageNo){
		...
		document.frm.action = "<c:url value='/admin/bbs/SelectBBSMasterInfsPop.do'/>";
		document.frm.submit();					
	}
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/bbs/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="title icon">&nbsp;게시판 정보</td>
	  <th >
	  </th>
	  <td width="10%" >
