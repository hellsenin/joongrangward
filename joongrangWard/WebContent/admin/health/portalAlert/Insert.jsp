...
<form name="fm" method="post" action="<c:url value='/admin/health/portalAlert/insert.do'/>" enctype="multipart/form-data" onsubmit="return checkAndSubmit(this);">

<table summary="알림 관리 등록 페이지" class="default_write">
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="3" class="output">
				<input type="text" name="pub_sdate" readonly="readonly"/><img src="/images/calendar.gif" width="24" height="22" border="0" align="absmiddle" onclick="Calendar_D(document.fm.pub_sdate)"/>
    			~
				<input type="text" name="pub_edate" readonly="readonly"/><img src="/images/calendar.gif" width="24" height="22" border="0" align="absmiddle" onclick="Calendar_D(document.fm.pub_edate)"/>
			</td>
		</tr>
		<tr>
