...
<form name="fm" method="post" action="<c:url value='/admin/health/poll/checkform/insert.do'/>" enctype="multipart/form-data" onsubmit="return checkAndSubmit(this);">
	<input type="hidden" name="year_cd" value="000000" />

	<table summary="자율점검 (점검표관리) 페이지" class="default_view">
		...
		<tbody>
			...
			<tr>
				...
				<td class="output" colspan="3">
					<input type="text" name="start_dt" id="start_dt" title="응모기간 (시작일자)" style="width: 80px; padding-left: 5px;" class="board1" readonly="readonly"/><img src="/health/open_content/images/calendar.gif" width="24" height="22" border="0" onclick="Calendar_D(document.fm.start_dt)"/>
					<span style="width: 5px;"></span> ~ <span style="width: 5px;"></span>
					<input type="text" name="end_dt" id="end_dt" title="응모기간 (종료일자)" style="width: 80px; padding-left: 5px;" class="board1" readonly="readonly"/><img src="/health/open_content/images/calendar.gif" width="24" height="22" border="0" onclick="Calendar_D(document.fm.end_dt)"/>
				</td>
			</tr>
