...
<form name="fm" method="post" action="<c:url value='/admin/health/poll/checkform/insertQuestion1.do'/>" enctype="multipart/form-data" onsubmit="return checkAndSubmit(this);">


	<table summary="자율점검 (점검표관리) : 점검표별 문제 페이지" class="default_write">
