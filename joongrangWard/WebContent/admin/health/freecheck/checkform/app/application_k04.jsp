		...
		<tbody>
			...
			<tr>
				...
				<td class="output" colspan="3">
					<div>
					<label for="addr2">영업소</label> : <input id="addr2" type="text" name="addr2" style="width:210px;" class="t_text vam" value="${fn:replace(answer.ADDR2 == null ? Bean.addr2 : answer.ADDR2, '서울특별시 종로구  ', '')}" <c:if test="${Bean.view_state == 'readonly'}"> disabled='disabled'</c:if>/>
