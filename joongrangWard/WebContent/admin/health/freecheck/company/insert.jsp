...
function checkId() {
	...
	if(idVal.length > 11) {
		...
		var returnVal = window.showModalDialog("/admin/freecheck/company/checkId.do?id="+idVal+"&company_cd=0", '','');
...
function refresh() {
	document.fm.action = "<c:url value='/admin/freecheck/company/forInsert.do'/>";
	document.fm.submit();
};
</script>
</head>
...
<form name="fm" method="post" action="<c:url value='/admin/freecheck/company/insert.do'/>" enctype="multipart/form-data" onsubmit="return checkAndSubmit(this);">
	<table summary="자율점검 (업소관리) 페이지" class="default_write">
		<caption>자율점검 (업소관리)</caption>
		<colgroup>
			<col width="20%" />
			<col width="30%" />
			<col width="20%" />
		...
		<tbody>
			...
			<tr>
				...
				<td class="output">
					<select name="industry_cd" id="industry_cd" style="width: 180px;" class="select">
						<c:forEach items="${resultIndustrySelection}" var="industry_item">
							<option value='${industry_item.industry_cd}'>${industry_item.divide_cd_name} - ${industry_item.name}</option>
						</c:forEach>
					</select>
				</td>
				<th scope="row"><label for="company">업체명</label></th>
				<td class="output">
					<input type="text" name="company" id="company" style="width: 180px;" class="board1" value=""/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="output" colspan="3">
					<input type="text" name="ceo_name" id="ceo_name" style="width: 180px;" class="board1" value=""/>
				</td>
				<!-- 
			...
			<tr>
				...
				<td class="output">
					<input type="text" name="sa_no" id="sa_no" style="width: 180px;" class="board1" value=""/>
				</td>
				<th scope="row"><label for="pharmacist_no">면허번호</label></th>
				<td class="output">
					<input type="text" name="pharmacist_no" id="pharmacist_no" style="width: 180px;" class="board1" value="${Bean.pharmacist_no}"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="output">
					<input type="text" name="tel" id="tel" style="width: 180px;" class="board1" value=""/>
				</td>
				<th scope="row"><label for="fax">팩스번호</label></th>
				<td class="output">
					<input type="text" name="fax" id="fax" style="width: 180px;" class="board1" value=""/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="output">
					<input type="text" name="hp" id="hp" style="width: 180px;" class="board1" value=""/>
				</td>
				<th scope="row"><label for="email">e메일</label></th>
				<td class="output">
					<input type="text" name="email" id="email" style="width: 180px;" class="board1" value=""/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="output" colspan="3">
					<input type="text" id="zipcode1" name="zipcode1" value="" style="width: 30px; text-align: center;" class="board1" title="우편번호 앞자리 번호" /> -
					<input type="text" id="zipcode2" name="zipcode2" value="" style="width: 30px; text-align: center;" class="board1" title="우편번호 뒷자리 번호" />
					...
					<br/>
					<input type="text" name="addr1" id="addr1" value="" style="width: 400px;"/>
				</td>
			</tr>
